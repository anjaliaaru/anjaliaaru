...
export class App extends Component {
  ...
  <Routes>
        <Route  exact path="/"element={<News key=" genral" pageSize={5} country="in" category="genral"/>} ></Route>
        ...
        <Route  exactpath="/genral"element={<News  key="genral"pageSize={5} country="in" category="genral"/>}></Route>
